...
export function BookCallSection() {
  ...
  function pickTime(t: string) {
    setActiveTime(t);
    setSubmitError(null);
    // On mobile, automatically advance to the form step
  ...
  return (
    <div className="mx-auto max-w-4xl overflow-hidden rounded-3xl border border-line/70 bg-white shadow-card">
      <div className="flex flex-col md:flex-row">
        ...
        {/* ── Left: Calendar panel ── */}
        <div className={`flex-1 border-b border-line/60 p-6 md:border-b-0 md:border-r md:p-8 ${mobileStep === 'details' ? 'hidden md:block' : 'block'}`}>
        ...
        {/* ── Right: Form panel ── */}
        <div className={`flex-1 p-6 md:p-8 ${mobileStep === 'pick' ? 'hidden md:block' : 'block'}`}>
          {!activeTime ? (
            /* No time selected — desktop placeholder */
            <div className="flex h-full min-h-[260px] flex-col items-center justify-center text-center">
              ...
              <p className="mt-4 max-w-[180px] text-sm leading-relaxed text-ink-muted">
